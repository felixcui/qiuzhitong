...
## 3. 设计系统
- **主题**：「墨韵 · 深红」— 暖米色纸感背景 + 深红权威主色 + 暖金辅助
- **背景**：`#F8F5F0` 暖米白 + 28px 点阵径向渐变纹理（营造纸感）
- **主色**：`--party-red: #C8190C`（深沉权威红）
- **字体**：Noto Serif SC（标题衬线）+ Noto Sans SC（正文）
- **阴影**：三级阴影系统（card / card-hover 红色辉光 / float）
...
| 版本 | 日期 | 描述 |
| :--- | :--- | :--- |
| V1.0 | 2026-02-04 | 初始版本：核心导航、搜索、弹窗、无障碍支持 |
| V1.1 | 2026-03-31 | UI 升级：「墨韵 · 深红」主题，点阵背景纹理，侧边栏计数 badge，Hero 统计数字，卡片微动效增强 |
